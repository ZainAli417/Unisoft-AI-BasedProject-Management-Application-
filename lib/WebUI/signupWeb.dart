...
class SignUpWeb extends StatefulWidget {
  final String email;
  const SignUpWeb({super.key, required this.email});
  @override
                                ...
                                child: Stack(
                                  children: [
                                    ProfileDummy(
                                      ...
                                      scale: Utils.screenWidth * 0.0020,
