...
import 'package:unisoft/WebUI/resetPasswordWeb.dart';
                      ...
                      children: [
                        ...
                        LabelledFormInput(
                          validator: (value) {
                            if (value!.isEmpty) {
                              return AppConstants
                                  .password_can_not_be_empty_key.tr;
                        ...
                        GestureDetector(
                          onTap: () {
                              Get.to(() => const ResetPasswordScreenWeb());
                          },
                          child: Row(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              //onTap: widget.onTap,
                              onTap: () {
                                Get.to(() => const EmailAddressScreenWeb());
                              },
                              child: Text(
