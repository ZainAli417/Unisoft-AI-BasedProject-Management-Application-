...
import 'package:unisoft/controllers/taskController.dart';
...
class ProjectController extends ProjectAndTaskController {
    ...
    if (await existByOne(
      ...
      if (projectModel.teamId != null) {
        if (await existByTow(
          ...
          if (anotherProjects.docs.isEmpty) {
            Exception exception =
  ...
  Future<List<ProjectModel>> getProjectsOfTeamZ(
  ...
  Stream<QuerySnapshot<ProjectModel?>> getProjectsOfMemberWhereUserIs2Stream(
    ...
    if (projects.isEmpty) {
      throw Exception("No. project I am member of");
    }
