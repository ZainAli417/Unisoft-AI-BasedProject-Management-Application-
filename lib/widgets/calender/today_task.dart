...
import 'package:unisoft/widgets/calender/widgets/circle_gradient_icon.dart';
import 'package:unisoft/widgets/calender/widgets/task.dart';
                ...
                children: [
                  ...
                  StreamBuilder<QuerySnapshot<ProjectSubTaskModel>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        var varo = snapshot.data!.docs;
                        List<ProjectSubTaskModel> tasksList = [];
                        for (var element in varo) {
                          tasksList.add(element.data());
                        }
                        return Column(
                  ...
                  StreamBuilder<QuerySnapshot<ProjectMainTaskModel>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        var varo = snapshot.data!.docs;
                        List<ProjectMainTaskModel> tasksList = [];
                        for (var element in varo) {
                          tasksList.add(element.data());
                        }
                        return Column(
