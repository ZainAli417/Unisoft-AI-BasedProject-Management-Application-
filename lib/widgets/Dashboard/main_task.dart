...
import 'package:unisoft/widgets/Dashboard/subTasks.dart';
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                ...
                                                gradient: LinearGradient(
                                                  colors: [
                                                    HexColor.fromHex("3f184f"),
                                                    HexColor.fromHex("f2f5ff")],
                                                ),
                                              ),
                                            ),
                                          ),
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppSpaces.verticalSpace10,
                          Text(
                            '${widget.completed.toInt()} off  ${widget.all.toInt()}  ${AppConstants.is_completed_key.tr}', // Use the rating property of taskModel
                            style: GoogleFonts.laila(
                              color: Colors.red,
                              fontWeight: FontWeight.w500,
                              fontSize: 15,
...
Widget _buildStatus(int importance) {
  const maxOpacity = 1; // Maximum opacity for the task
