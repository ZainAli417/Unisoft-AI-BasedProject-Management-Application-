...
import 'package:unisoft/Screens/Projects/editProject.dart';
import 'package:unisoft/Screens/Projects/projectScreenCotroller.dart';
...
import 'package:unisoft/widgets/User/focused_menu_item.dart';
        ...
        return Column(
          ...
          children: [
              ...
              child: SafeArea(
                child: TaskezAppHeader(
                  ...
                  widget: Container(
                    ...
                    child: IconButton(
                      icon: Icon(
                        size: 20, // Adjust the percentage as needed
            ...
            Padding(
              padding: EdgeInsets.only(
                right:
                    Utils.screenWidth * 0.001, // Adjust the percentage as needed
                left:
                    Utils.screenWidth * 0.01, // Adjust the percentage as needed
              ),
              child: Row(
