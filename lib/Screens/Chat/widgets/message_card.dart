        ...
        Flexible(
          child: Container(
            ...
            margin: EdgeInsets.symmetric(
                horizontal: mq.size.width * .03,
                vertical: mq.size.height * .01),
            decoration: BoxDecoration(
                color: HexColor.fromHex("#0084FF"),
        ...
        Flexible(
          child: Container(
            ...
            margin: EdgeInsets.symmetric(
                ...
                vertical: mq.size.height * .01),
            decoration: BoxDecoration(
                color: HexColor.fromHex("#0FC356"), //making borders curved
                borderRadius: const BorderRadius.only(
                    topLeft: Radius.circular(20),
                    topRight: Radius.circular(20),
...
class _OptionItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    mq2 = MediaQuery.of(context);
    return InkWell(
        onTap: () => onTap(),
        child: Padding(
          padding: EdgeInsets.only(
              left: mq2.size.width * .05,
              top: mq2.size.height * .015,
              bottom: mq2.size.height * .015),
          child: Row(children: [
            icon,
            Flexible(
                child: Text('    $name',
